 ...
 */
public class newModelEditor extends BaseEditor {

	//private static final Logger LOGGER = Logger.getLogger(ExceptionEditor.class);

	private final newModelEditorView view = new newModelEditorView();

	private final DefaultAction closeAction = new DefaultAction(e -> commandClose(), this, ERDesignerBundle.CLOSE);

	public newModelEditor(Component aParent) {
		super(aParent, ERDesignerBundle.NEWMODEL);
		...
		view.getinfoText().setText("This icon will create an empty model.");
	}
