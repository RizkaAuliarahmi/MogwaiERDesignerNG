 ...
 */
public class zoomInModelEditor extends BaseEditor {

	//private static final Logger LOGGER = Logger.getLogger(ExceptionEditor.class);

	private final zoomInModelEditorView view = new zoomInModelEditorView();

	private final DefaultAction closeAction = new DefaultAction(e -> commandClose(), this, ERDesignerBundle.CLOSE);

	public zoomInModelEditor(Component aParent) {
		super(aParent, ERDesignerBundle.ZOOMIN);
		...
		view.getinfoText().setText("This icon can zooming in the model");
	}
