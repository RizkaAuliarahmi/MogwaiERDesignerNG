 ...
 */
public class zoomOutModelEditor extends BaseEditor {

	//private static final Logger LOGGER = Logger.getLogger(ExceptionEditor.class);

	private final zoomOutModelEditorView view = new zoomOutModelEditorView();

	private final DefaultAction closeAction = new DefaultAction(e -> commandClose(), this, ERDesignerBundle.CLOSE);

	public zoomOutModelEditor(Component aParent) {
		super(aParent, ERDesignerBundle.ZOOMOUT);
		...
		view.getinfoText().setText("This icon can zooming out the model");
	}
