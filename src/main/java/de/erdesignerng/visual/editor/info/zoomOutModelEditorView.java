 ...
 */
public class zoomOutModelEditorView extends JPanel {

    private JPanel buttonPanel;

    private DefaultButton closeButton;

    private DefaultTextArea infoText;

    /**
     * Constructor.
     */
    public zoomOutModelEditorView() {
        initialize();
    ...
    private void initialize() {
        ...
        add(getinfoText().getScrollPane(), cons.xywh(2, 2, 1, 1));
    }
     ...
     * @return the initialized component
     */
    public DefaultTextArea getinfoText() {

        if (infoText == null) {
            infoText = new DefaultTextArea();
            infoText.setName("Icon Info");
        }
